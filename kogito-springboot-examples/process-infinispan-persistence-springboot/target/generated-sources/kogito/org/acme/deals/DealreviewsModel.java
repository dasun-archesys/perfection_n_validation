...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "dealreviews", name = "Dealreviews", hidden = false)
public class DealreviewsModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<DealreviewsModelOutput> {
    ...
    @Override()
    public DealreviewsModelOutput toModel() {
        DealreviewsModelOutput result = new DealreviewsModelOutput();
        result.setId(getId());
