...
public class ProtostreamObjectMarshaller implements ObjectMarshallerStrategy {
    ...
    public ProtostreamObjectMarshaller() {
        ...
        try {
            ...
            context.registerMarshaller(new org.kie.kogito.app.AddressMessageMarshaller());
            context.registerMarshaller(new org.kie.kogito.app.TravellerMessageMarshaller());
        } catch (IOException e) {
        }
    }
