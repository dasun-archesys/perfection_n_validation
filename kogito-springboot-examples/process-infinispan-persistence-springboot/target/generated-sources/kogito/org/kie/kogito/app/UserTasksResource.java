...
public class UserTasksResource {
    ...
    @org.springframework.transaction.annotation.Transactional()
    public UserTaskView transition(@PathVariable("taskId") String taskId, @RequestParam("user") String user, @RequestParam("group") List<String> groups, @RequestBody TransitionInfo transitionInfo) {
        return userTaskService.transition(taskId, transitionInfo.getTransitionId(), transitionInfo.getData(), identityProviderFactory.getOrImpersonateIdentity(user, groups)).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }

    @GetMapping(value = "/{taskId}/transition", produces = MediaType.APPLICATION_JSON_VALUE)
    @org.springframework.transaction.annotation.Transactional()
    public Collection<UserTaskTransitionView> transition(@PathVariable("taskId") String taskId, @RequestParam("user") String user, @RequestParam("group") List<String> groups) {
    ...
    @org.springframework.transaction.annotation.Transactional()
    public UserTaskView setOutput(@PathVariable("taskId") String taskId, @RequestParam("user") String user, @RequestParam("group") List<String> groups, @RequestBody String body) throws Exception {
    ...
    @org.springframework.transaction.annotation.Transactional()
    public UserTaskView setInputs(@PathVariable("taskId") String taskId, @RequestParam("user") String user, @RequestParam("group") List<String> groups, @RequestBody String body) throws Exception {
        Map<String, Object> data = mapper.readValue(body, Map.class);
    ...
    @org.springframework.transaction.annotation.Transactional()
    public Collection<Comment> getComments(@PathVariable("taskId") String taskId, @RequestParam("user") String user, @RequestParam("group") List<String> groups) {
        return userTaskService.getComments(taskId, identityProviderFactory.getOrImpersonateIdentity(user, groups));
    }

    @PostMapping("/{taskId}/comments")
    @org.springframework.transaction.annotation.Transactional()
    public Comment addComment(@PathVariable("taskId") String taskId, @RequestParam("user") String user, @RequestParam("group") List<String> groups, @RequestBody CommentInfo commentInfo) {
    ...
    @org.springframework.transaction.annotation.Transactional()
    public Comment getComment(@PathVariable("taskId") String taskId, @PathVariable("commentId") String commentId, @RequestParam("user") String user, @RequestParam("group") List<String> groups) {
        return userTaskService.getComment(taskId, commentId, identityProviderFactory.getOrImpersonateIdentity(user, groups)).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Comment " + commentId + " not found"));
    }

    @PutMapping("/{taskId}/comments/{commentId}")
    @org.springframework.transaction.annotation.Transactional()
    public Comment updateComment(@PathVariable("taskId") String taskId, @PathVariable("commentId") String commentId, @RequestParam("user") String user, @RequestParam("group") List<String> groups, @RequestBody CommentInfo commentInfo) {
    ...
    @org.springframework.transaction.annotation.Transactional()
    public Comment deleteComment(@PathVariable("taskId") String taskId, @PathVariable("commentId") String commentId, @RequestParam("user") String user, @RequestParam("group") List<String> groups) {
    ...
    @org.springframework.transaction.annotation.Transactional()
    public Collection<Attachment> getAttachments(@PathVariable("taskId") String taskId, @RequestParam("user") String user, @RequestParam("group") List<String> groups) {
        return userTaskService.getAttachments(taskId, identityProviderFactory.getOrImpersonateIdentity(user, groups));
    }

    @PostMapping("/{taskId}/attachments")
    @org.springframework.transaction.annotation.Transactional()
    public Attachment addAttachment(@PathVariable("taskId") String taskId, @RequestParam("user") String user, @RequestParam("group") List<String> groups, @RequestBody AttachmentInfo attachmentInfo) {
    ...
    @org.springframework.transaction.annotation.Transactional()
    public Attachment updateAttachment(@PathVariable("taskId") String taskId, @PathVariable("attachmentId") String attachmentId, @RequestParam("user") String user, @RequestParam("group") List<String> groups, @RequestBody AttachmentInfo attachmentInfo) {
        Attachment attachment = new Attachment(attachmentId, user);
        attachment.setName(attachmentInfo.getName());
        attachment.setContent(attachmentInfo.getUri());
        return userTaskService.updateAttachment(taskId, attachment, identityProviderFactory.getOrImpersonateIdentity(user, groups)).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }

    @DeleteMapping(value = "/{taskId}/attachments/{attachmentId}", consumes = MediaType.ALL_VALUE)
    @org.springframework.transaction.annotation.Transactional()
    public Attachment deleteAttachment(@PathVariable("taskId") String taskId, @PathVariable("attachmentId") String attachmentId, @RequestParam("user") String user, @RequestParam("group") List<String> groups) {
    ...
    @org.springframework.transaction.annotation.Transactional()
    public Attachment getAttachment(@PathVariable("taskId") String taskId, @PathVariable("attachmentId") String attachmentId, @RequestParam("user") String user, @RequestParam("group") List<String> groups) {
        return userTaskService.getAttachment(taskId, attachmentId, identityProviderFactory.getOrImpersonateIdentity(user, groups)).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Attachment " + attachmentId + " not found"));
    }
}
